# AUTO RPG 
## TURN BASED GAME INSPIRED BY [IDLE HEROES](https://play.google.com/store/apps/details?id=com.droidhang.ad&hl=en_US&pli=1)
...
```sh
git clone https://github.com/ascndia/autorpg auto-rgg
cd auto-rpg
yarn install
```
